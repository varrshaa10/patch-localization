...
def generate_set_d_pair(architecture, pair_id, output_dir, variant_offset=0):
    ...
    return {
        ...
        "category": "present",
        "ref_path": f"../tests/synthetic_data_phase2_set_d/pair_{pair_id}/reference.png",
        "search_path": f"../tests/synthetic_data_phase2_set_d/pair_{pair_id}/search.png",
...
def generate_pair(architecture, pair_id, category, output_dir, severity=None):
    ...
    return {
        ...
        "architecture": architecture,
        "category": category,
        "ref_path": f"../tests/synthetic_data_phase2/pair_{pair_id}/reference.png",
        "search_path": f"../tests/synthetic_data_phase2/pair_{pair_id}/search.png",
