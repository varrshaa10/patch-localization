...
THRESHOLD = 0.001
CSV_PATH = ROOT / 'algorithm' / 'tests' / 'synthetic_data_phase2_v2' / 'ground_truth_combined.csv'
...
print('present_true', sum(1 for _, t, _, _ in results if t == 1))
print('absent_true', sum(1 for _, t, _, _ in results if t == 0))
